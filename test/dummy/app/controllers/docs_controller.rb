...
class DocsController < ApplicationController
  ...
  def gem_views
    prefix = "#{RecordingStudioPublishedArticle::Engine.root}/"

    @engine_views = Dir.glob(RecordingStudioPublishedArticle::Engine.root.join("app/views/recording_studio_published_article/**/*.erb").to_s)
      .sort
