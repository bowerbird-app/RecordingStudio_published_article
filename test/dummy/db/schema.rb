...
ActiveRecord::Schema[8.1].define(version: 2026_09_17_000005) do
  ...
  create_table "recording_studio_publications_catalogues", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.datetime "created_at", null: false
  end

  create_table "recording_studio_publications_publications", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.datetime "created_at", null: false
    t.string "key", null: false
  ...
  create_table "recording_studio_published_article_articles", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.string "author"
    t.datetime "created_at", null: false
    t.text "excerpt"
    ...
    t.string "url"
    t.index ["author"], name: "index_recording_studio_published_article_articles_on_author"
    t.index ["publication_recording_id"], name: "idx_on_publication_recording_id_49cc6534a2"
    t.index ["published_at"], name: "idx_on_published_at_740aab2788"
    t.index ["title"], name: "index_recording_studio_published_article_articles_on_title"
  end
